...
def update_infection_rate(count,g):
    ...
    with open('SIR_Outputs/degree_centrality/sir_infection_status.csv','a',newline='') as newFile:
...
def plot_infection_rates():
    infection_df=pd.read_csv('SIR_Outputs/degree_centrality/sir_infection_status.csv')
    #ax = plt.gca()
    ...
    #fig=plt.figure()
    plt.savefig('SIR_Outputs/degree_centrality/graph_sir_plot.png')
...
plt.savefig('SIR_Outputs/degree_centrality/graph_sir_0.png')
...
with open('SIR_Outputs/degree_centrality/sir_infection_status.csv','w',newline='') as newFile:
    newFileWriter = csv.writer(newFile)
...
plt.savefig('SIR_Outputs/degree_centrality/graph_sir_'+str(count)+'.png')
count=count+1
